...
public class MinBinHeap implements Heap_Interface {
    ...
    private StartPairImpl[] array; 
    private int size;
    private static final int arraySize = 10000;

    public MinBinHeap() {
        this.array = new StartPairImpl[arraySize];
        array[0] = new StartPairImpl(null, -100000);
    }
